...
3. The `summary` must:
   ...
   * Integrate and rewrite the essential parts of **{THREAD.SUMMARY}** when it is not `None`, while incorporating new context from the current conversation.
