...
- Built-in tools (memory, web_search, thread_search, thread_fetcher, thread_updater) are registered automatically when enabled in config; thread state filters to registered tool keys.
